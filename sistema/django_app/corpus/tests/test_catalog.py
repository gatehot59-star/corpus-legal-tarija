...
class CatalogTests(FixtureBase):
    ...
    def test_browse_passes_authorized_uids_and_filters(self, browse):
        """Browse delegates only eligible locators to the verified snapshot reader."""
        ...
        self.assertEqual(args[1], {"fixture-1"})
